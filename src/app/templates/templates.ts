...
export const templates = [
  ...
  {
    href: "/template/cat-ipsum",
    title: "Cat Ipsum",
    description: "Generate paragraphs of cat ipsum.",
    icon: Cat,
    hoverClasses: "hover:border-yellow-500/50 hover:shadow-yellow-900/20",
    hoverColorClass: "group-hover:text-yellow-400",
    unlisted: true,
  },
  {
    href: "/template/dog-ipsum",
    title: "Dog Ipsum",
    description: "Generate paragraphs of dog ipsum.",
    icon: Dog,
    hoverClasses: "hover:border-red-500/50 hover:shadow-red-900/20",
